	...
	return (
		<div>
			<section className="app-content omf-brand-content">
				...
				<div className="w3-row">
					<div className="w3-col s12">
						<img src="assets/full/BRAND_SECOND_IMAGE.jpg" className="w3-image" />
					</div>
				</div>
				...
				<div className="w3-row">
					<div className="w3-col s12">
						<img src="assets/full/BRAND_COLLAGE.jpg" className="w3-image" />
					</div>
				</div>
				...
				<div className="w3-row">
					<div className="w3-col s12">
						<img src="assets/full/BRAND_LOGOS.jpg" className="w3-image" />
					</div>
				</div>
				...
				<div className="w3-row">
					<div className="w3-col s12">
						<img src="assets/full/BRAND_TYPE_FONTS.jpg" className="w3-image" />
					</div>
				</div>
				<div className="w3-row">
					<div className="w3-col s12">
						<img src="assets/full/BRAND_TYPE_POSTER_BROCHURE.jpg" className="w3-image" />
					</div>
				</div>
				<div className="w3-row">
					<div className="w3-col s12">
						<img src="assets/full/BRAND_DESKTOP_MOBILE.jpg" className="w3-image" />
					</div>
				</div>
				...
				<div className="w3-row">
					<div className="w3-col s12">
						<img src="assets/full/BRAND_COLOR_TILES.jpg" className="w3-image" />
					</div>
				</div>
				<div className="w3-row">
					<div className="w3-col s12">
						<img src="assets/full/BRAND_COLOR_LAPTOP.jpg" className="w3-image" />
					</div>
				</div>
				<div className="w3-row">
					<div className="w3-col s12">
						<img src="assets/full/BRAND_COLOR_BANNER_MOBILE.jpg" className="w3-image" />
					</div>
				</div>
				<div className="w3-row">
					<div className="w3-col s12">
						<img src="assets/full/BRAND_COLOR_BOOKLET.jpg" className="w3-image" />
					</div>
				</div>
				...
				<div className="w3-row">
					<div className="w3-col s12">
						<img src="assets/full/BRAND_PHOTOG_MOBILE.jpg" className="w3-image" />
					</div>
				</div>
				...
				<div className="w3-row">
					<div className="w3-col s12">
						<img src="assets/full/BRAND_ICONS.jpg" className="w3-image" />
					</div>
				</div>
				<div className="w3-row">
					<div className="w3-col s12">
						<img src="assets/full/BRAND_ICONS_LAPTOP.jpg" className="w3-image" />
					</div>
				</div>
				<div className="w3-row">
					<div className="w3-col s12">
						<img src="assets/full/BRAND_ICONS_MOBILE_ONSERT.jpg" className="w3-image" />
					</div>
				</div>
