	...
	return (
		<div>
			<section className="app-content omf-mainstreet-content">
				...
				<div className="w3-row">
					<div className="w3-col s12">
						<img src="assets/full/MOMS_Second_Image.jpg" className="w3-image" />
					</div>
				</div>
				...
				<div className="w3-row">
					<div className="w3-col s12">
						<img src="assets/full/MOMS_Collage1.jpg" className="w3-image" />
					</div>
				</div>
				<div className="w3-row">
					<div className="w3-col s12">
						<img src="assets/full/MOMS_POSTCARD_POSTER.jpg" className="w3-image" />
					</div>
				</div>
				<div className="w3-row">
					<div className="w3-col s12">
						<img src="assets/full/MOMS_COLLAGE2.jpg" className="w3-image" />
					</div>
				</div>
				...
				<div className="w3-row">
					<div className="w3-col s12">
						<img src="assets/full/MOMS_LAPTOP.jpg" className="w3-image" />
					</div>
				</div>
				<div className="w3-row">
					<div className="w3-col s12">
						<img src="assets/full/MOMS_MOBILE.jpg" className="w3-image" />
					</div>
				</div>
				<div className="w3-row">
					<div className="w3-col s12">
						<img src="assets/full/MOMS_COMPUTER_MOBILE.jpg" className="w3-image" />
					</div>
				</div>
				...
				<div className="w3-row">
					<div className="w3-col s12">
						<img src="assets/full/MOMS_VAN.jpg" className="w3-image" />
					</div>
				</div>
				<div className="w3-row">
					<div className="w3-col s12">
						<img src="assets/full/MOMS_BANNER_TEE.jpg" className="w3-image" />
					</div>
				</div>
