	...
	return (
		<div>
			<section className="app-content omf-email-content w3-animate-opacity">
				...
				<div className="w3-row">
					<div className="w3-col s12">
						<img src="assets/full/EMAIL_SECOND_IMAGE.jpg" className="w3-image" />
					</div>
				</div>
				...
				<div className="w3-row">
					<div className="w3-col s12">
						<img src="assets/full/EMAIL_BRAND_COLLAGE.jpg" className="w3-image" />
					</div>
				</div>
				<div className="w3-row">
					<div className="w3-col s12">
						<img src="assets/full/EMAIL_BEFORE_AFTER.jpg" className="w3-image" />
					</div>
				</div>
				...
				<div className="w3-row">
					<div className="w3-col s12">
						<img src="assets/full/EMAIL_TEMPLATES.jpg" className="w3-image" />
					</div>
				</div>
				...
				<div className="w3-row">
					<div className="w3-col s12">
						<img src="assets/full/EMAIL_MOBILE.jpg" className="w3-image" />
					</div>
				</div>
				<div className="w3-row">
					<div className="w3-col s12">
						<img src="assets/full/EMAIL_DESKTOP_MOBILE.jpg" className="w3-image" />
					</div>
				</div>
