...
const OMFWeb = () => {
	return (
		<div>
			<section className="app-content omf-web-content w3-animate-opacity">
				...
				<div className="w3-row">
					<div className="w3-col s12 project-section">
						<h2 className="project-subheader">Creative Direction, Visual Design, UX design, Responsive Site</h2>
						<h1 className="project-header">OneMain Financial Website Redesign</h1>
						<p>
				...
				<div className="w3-row">
					<div className="w3-col s12">
						<img src="assets/full/WEB_SECOND_IMAGE.jpg" className="w3-image" />
					</div>
				</div>

				<div className="w3-row">
					<div className="w3-col s12 project-section">
						<h2 className="project-subheader">OMF.com Redesign</h2>
						<p>
				...
				<div className="w3-row">
					<div className="w3-col s12">
						<img src="assets/full/WEB_COLLAGE.jpg" className="w3-image" />
					</div>
				</div>
				<div className="w3-row">
					<div className="w3-col s12">
						<img src="assets/full/WEB_BEFORE_AFTER.jpg" className="w3-image" />
					</div>
				</div>

				<div className="w3-row">
					<div className="w3-col s12 project-section">
						<h2 className="project-subheader">Sketch Templates</h2>
						<p>
				...
				<div className="w3-row">
					<div className="w3-col s12">
						<img src="assets/full/WEB_TEMPLATE.jpg" className="w3-image" />
					</div>
				</div>
				<div className="w3-row">
					<div className="w3-col s12">
						<img src="assets/full/WEB_DESKTOP_MOBILE.jpg" className="w3-image" />
					</div>
				</div>
				<div className="w3-row">
					<div className="w3-col s12">
						<img src="assets/full/WEB_MOBILE.jpg" className="w3-image" />
					</div>
				</div>
				<div className="w3-row">
					<div className="w3-col s12">
						<img src="assets/full/WEB_LAPTOP.jpg" className="w3-image" />
					</div>
				</div>
				...
				<div className="w3-row">
					<div className="w3-col s12">
						<img src="assets/full/WEB_HEADER_FOOTER.jpg" className="w3-image" />
					</div>
				</div>
